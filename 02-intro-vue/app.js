...
const app = createApp({
    setup() {
        ...
        const quotes = ref(originalQuotes); //hacemos quotes reactiva para que asi se actualice en el dom
        const newMessage = ref("");

        const totalQuotes = computed( () => { //Computed se encarga de actualizar el total
